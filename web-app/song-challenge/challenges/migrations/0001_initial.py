    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('harmony', models.ForeignKey(limit_choices_to={'can_do_harmny': True}, on_delete=django.db.models.deletion.CASCADE, related_name='harmony_set', to='challenges.instrument')),
